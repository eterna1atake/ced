                    ...
                    <div className="bg-slate-50 rounded-xl p-6 md:p-8">
                      ...
                      <div className="flex justify-center md:justify-start" data-aos="fade-up" data-aos-delay="400">
                        <button
                          ...
                          onClick={() => window.open("https://kmutnb.link/ComEDUiLab?fbclid=IwY2xjawOxBZJleHRuA2FlbQIxMABicmlkETFtN09NTHRUbFB6S0ZoNVVpc3J0YwZhcHBfaWQQMjIyMDM5MTc4ODIwMDg5MgABHp_i0KRcPeMM6stfI7uwOZn1zhr2tYZfjP1xK41Zkd6dP4SWWjPFzqQ7k1Vh_aem_bSe8R5Umjb1DFGZwwBsnjQ", "_blank", "noopener,noreferrer")}
                        >
